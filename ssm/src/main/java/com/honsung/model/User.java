...
public class User {
    ...
    public User(String id, String groupId, String loginId, String password, String pwdQuestion, String pwdAnswer, String name, String isAdmin, String agentStatus, String email, String loginIp, String enableStatus, Date enableDate, String auditFlag, String auditUser, Date auditTime, String createUser, Date createDate, String modifyUser, Date modifyDate, Date loginDate, Date retireDate, String systemCode, Integer failedTimes) {
        this.id = id;
