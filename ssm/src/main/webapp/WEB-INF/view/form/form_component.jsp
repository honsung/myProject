...
<%@include file="/WEB-INF/view/common/global.jsp" %>
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/bootstrap-fileupload.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/jquery.gritter.css" />
	...
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/jquery.tagsinput.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/clockface.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/bootstrap-wysihtml5.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/datepicker.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/timepicker.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/colorpicker.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/bootstrap-toggle-buttons.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/daterangepicker.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/datetimepicker.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/multi-select-metro.css" />
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/static/css/bootstrap-modal.css" />

	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/ckeditor.js"></script>  
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/bootstrap-fileupload.js"></script>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/wysihtml5-0.3.0.js"></script> 
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/bootstrap-wysihtml5.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/jquery.tagsinput.min.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/jquery.toggle.buttons.js"></script>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/clockface.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/date.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/daterangepicker.js"></script> 
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/bootstrap-colorpicker.js"></script>  
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/bootstrap-timepicker.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/jquery.inputmask.bundle.min.js"></script>   
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/jquery.input-ip-address-control-1.0.min.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/jquery.multi-select.js"></script>   
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/bootstrap-modal.js" ></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/bootstrap-modalmanager.js" ></script> 
    <script type="text/javascript" src="<%=request.getContextPath()%>/static/js/app.js"></script> 
	<script type="text/javascript" src="<%=request.getContextPath()%>/static/js/form-components.js"></script>      
</head>
							...
							<div class="portlet-body form">
								...
								<form action="#" class="form-horizontal">
									...
									<div class="control-group">
										...
										<label class="control-label">Custom Dropdown 多重选择</label>
					...
					<div class="span12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>多重选择</div>
							...
							<div class="span12">
								...
								<div class="portlet box purple">
									...
									<div class="portlet-title">
										...
										<div class="caption"><i class="icon-reorder"></i>Select 2 下拉框</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													<select name="" id="select2_sample4" class="span6 select2">
														...
														<option value="AR" checked>Argentina</option>
					...
					<div class="span12">
						...
						<div class="portlet box blue ">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>IP地址输入</div>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>输入掩码</div>
					...
					<div class="span12">
						...
						<div class="portlet box purple">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>标签输入</div>
										...
										<div class="controls">
											...
											<div class="fileupload fileupload-new" data-provides="fileupload">
												...
												<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
													...
													<img src="<%=request.getContextPath()%>/static/image/AAAAAA&amp;text=no+image" alt="" />
					...
					<div class="span12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>颜色选择器</div>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>日期时间选择器</div>
					...
					<div class="span12">
						...
						<div class="portlet box grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>日期选择器</div>
					...
					<div class="span12">
						...
						<div class="portlet box red">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>时间选择器</div>
							...
							<div class="portlet-body form">
								...
								<form action="#" class="form-horizontal">
									...
									<div class="control-group">
										...
										<label class="control-label">内联</label>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											在模态窗口中查看钟面时间选择器 <i class="icon-share"></i>
					...
					<div class="span12">
						...
						<div class="portlet box yellow">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>日期范围选择器</div>
